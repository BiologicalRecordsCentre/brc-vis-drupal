...
export function taxonSelect () {
  ...
  $('.brc_vis_taxon_selector').each(function(){
    ...
    const $wrapper = $('<div>').appendTo($(this))
      ...
      data: {
        src: async (query) => {
          ...
          try {
            ...
            const url = `https://warehouse1.indicia.org.uk/index.php/services/rest/taxa/search${params}searchQuery=${query}`
            //const url = `https://warehouse1.indicia.org.uk/index.php/services/rest/taxa/search?include=data&taxon_list_id=15&searchQuery=${query}`
